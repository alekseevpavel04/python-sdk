...
1. **🤖 For AI coding agents**: Check out
   [AGENTS.md](https://github.com/aignostics/python-sdk/blob/main/AGENTS.md)
   with comprehensive guidance for AI coding agents (Claude, GitHub Copilot, Cursor, etc.) including workflows, gotchas, and quick references.
2. **For contributors**: Check out
   [CLAUDE.md](https://github.com/aignostics/python-sdk/blob/main/CLAUDE.md)
   with architectural overview and module documentation index.
3. Inspect our
...
9. We gratefully acknowledge the numerous
