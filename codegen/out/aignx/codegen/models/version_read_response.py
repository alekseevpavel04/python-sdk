...
class VersionReadResponse(BaseModel):
    """
    Response schema for the `Application Version Details` endpoint
    """ # noqa: E501
    ...
    # TODO(Andreas): Please have this legacy attribute removed in api
    application_version_id: StrictStr = Field(description="Application version ID")
    # TODO(Andreas): Please have this internal attribute removed in public API
    flow_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["version_number", "application_id", "changelog", "input_artifacts", "output_artifacts", "released_at", "application_version_id", "flow_id"]
