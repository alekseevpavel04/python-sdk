...
class ItemResultReadResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["item_id", "external_id", "custom_metadata", "custom_metadata_checksum", "state", "output", "termination_reason", "error_message", "terminated_at", "output_artifacts"]
