...
@pytest.mark.sequential
def test_cli_set_unset_get(runner: CliRunner, silent_logging) -> None:
...
@pytest.mark.sequential
def test_cli_remote_diagnostics(runner: CliRunner, silent_logging) -> None:
...
@pytest.mark.sequential
def test_cli_http_proxy(runner: CliRunner, silent_logging, tmp_path) -> None:  # noqa: PLR0915
    """Check disable/enable remote diagnostics."""
